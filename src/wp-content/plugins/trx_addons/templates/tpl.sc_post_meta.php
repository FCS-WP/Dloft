...
?><div class="<?php echo esc_attr($sc); ?>_post_meta post_meta"><?php
	...
	foreach ($components as $comp) {
		...
		// Post date
			...
			?><span class="post_meta_item post_date<?php if (!empty($args['seo'])) echo ' date updated'; ?>"<?php if (!empty($args['seo'])) trx_addons_seo_snippets('datePublished'); ?>><a href="<?php echo esc_url(get_permalink()); ?>"><?php echo apply_filters('trx_addons_filter_get_post_date', get_the_date()); ?></a></span><?php
