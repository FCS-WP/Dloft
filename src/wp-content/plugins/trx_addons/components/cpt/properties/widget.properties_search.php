...
// Widget Class
class trx_addons_widget_properties_search extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'trx_addons_widget_properties_search', esc_html__('ThemeREX Addons - Properties Search', 'trx_addons'), $widget_ops );
	}
...
if ( !function_exists( 'trx_addons_sc_widget_properties_search' ) ) {
	function trx_addons_sc_widget_properties_search($atts, $content=null){	
		...
		extract($atts);
		$type = 'trx_addons_widget_properties_search';
		$output = '';
		...
		if ( is_object( $wp_widget_factory ) && isset( $wp_widget_factory->widgets, $wp_widget_factory->widgets[ $type ] ) ) {
			...
			the_widget( $type, $atts, trx_addons_prepare_widgets_args($TRX_ADDONS_STORAGE['widgets_args'], 
												$id ? $id.'_widget' : 'widget_properties_search',
												'widget_properties_search') );
