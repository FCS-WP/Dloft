							...
							foreach($trx_addons_gallery as $trx_addons_image) {
								if ($trx_addons_image != '') {
									...
									if (!empty($trx_addons_thumb)) {
										...
										?><span class="properties_page_gallery_item" data-image="<?php echo esc_url($trx_addons_image); ?>"><?php
...
*/	
	...
	trx_addons_get_template_part('templates/tpl.posts-related.php',
										...
										apply_filters('trx_addons_filter_args_related', array(
															'class' => 'properties_page_related',
															'posts_per_page' => 3,
															'columns' => 3,
															'template' => TRX_ADDONS_PLUGIN_CPT . 'properties/tpl.properties.default-item.php',
