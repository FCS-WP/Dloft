...
while ( have_posts() ) { the_post();
	?>
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'dishes_page itemscope' ); trx_addons_seo_snippets('', 'Article'); ?>>
	...
	trx_addons_get_template_part('templates/tpl.posts-related.php',
										...
										apply_filters('trx_addons_filter_args_related', array(
															...
															'posts_per_page' => 3,
															'columns' => 3,
															'template' => TRX_ADDONS_PLUGIN_CPT . 'dishes/tpl.default-item.php',
