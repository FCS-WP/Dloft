...
<div class="sc_dishes_item with_image<?php
	...
	<div class="sc_dishes_item_info">
		<div class="sc_dishes_item_header">
			<h4 class="sc_dishes_item_title"><a href="<?php echo esc_url($link); ?>"><?php the_title(); ?></a></h4>
		...
		<?php if (!isset($args['hide_excerpt']) || (int)$args['hide_excerpt']==0) { ?>
			...
			<div class="sc_dishes_item_button sc_item_button">
				<a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Learn more', 'trx_addons'); ?></a>
				<?php
				if ((int)$meta['product'] > 0) {
					?><a href="<?php echo esc_url(get_permalink($meta['product'])); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Order now', 'trx_addons'); ?></a><?php
				}
				?>
			</div>
		<?php } ?>
