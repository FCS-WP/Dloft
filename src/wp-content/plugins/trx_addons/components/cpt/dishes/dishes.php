...
if ( !function_exists( 'trx_addons_cpt_dishes_load_scripts_front' ) ) {
	...
	function trx_addons_cpt_dishes_load_scripts_front() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx_addons-cpt_dishes', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_CPT . 'dishes/dishes.css'), array(), null );
		}
	}
}
...
if ( !function_exists( 'trx_addons_cpt_dishes_merge_styles' ) ) {
	...
	function trx_addons_cpt_dishes_merge_styles($list) {
		$list[] = TRX_ADDONS_PLUGIN_CPT . 'dishes/dishes.css';
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_cpt_dishes_merge_scripts' ) ) {
	...
	function trx_addons_cpt_dishes_merge_scripts($list) {
		$list[] = TRX_ADDONS_PLUGIN_CPT . 'dishes/dishes.js';
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_sc_dishes' ) ) {
	function trx_addons_sc_dishes($atts, $content=null) {	
		...
		if (trx_addons_is_on(trx_addons_get_option('debug_mode')))
			wp_enqueue_script( 'trx_addons-cpt_dishes', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_CPT . 'dishes/dishes.js'), array('jquery'), null, true );
	...
	class TRX_Addons_SOW_Widget_Dishes extends TRX_Addons_SOW_Widget {
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('ThemeREX Addons SOW - Dishes', 'trx_addons'),
				array(
