...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'dishes_page' ); ?>>
	...
	// Buttons
	if ( comments_open() || get_comments_number() || (int)$meta['product'] > 0) {
		?><section class="dishes_page_button sc_item_button"><?php
