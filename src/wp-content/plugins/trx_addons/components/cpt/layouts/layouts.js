...
jQuery(document).on('action.ready_trx_addons', function() {
	...
	// Return total height of all fixed rows
	window.trx_addons_cpt_layouts_fixed_rows_height = function() {
		var fixed_height = 0;
		jQuery('.sc_layouts_row_fixed').each(function() {
			fixed_height += jQuery(this).height();
		});
		return fixed_height;
	};
