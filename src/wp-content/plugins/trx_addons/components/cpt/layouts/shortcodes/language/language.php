...
if ( !function_exists( 'trx_addons_sc_layouts_language_load_scripts_front' ) ) {
	...
	function trx_addons_sc_layouts_language_load_scripts_front() {
		if (function_exists('trx_addons_exists_wpml') && trx_addons_exists_wpml()) {
			if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
				wp_enqueue_style( 'trx_addons-sc_layouts_menu', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_CPT_LAYOUTS_SHORTCODES . 'menu/menu.css'), array(), null );
				wp_enqueue_style( 'trx_addons-sc_layouts_language', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_CPT_LAYOUTS_SHORTCODES . 'language/language.css'), array(), null );
			}
		}
	}
}
...
if ( !function_exists( 'trx_addons_sc_layouts_language_merge_styles' ) ) {
	...
	function trx_addons_sc_layouts_language_merge_styles($list) {
		$list[] = TRX_ADDONS_PLUGIN_CPT_LAYOUTS_SHORTCODES . 'language/language.css';
		return $list;
	}
}
	...
	class TRX_Addons_SOW_Widget_Layouts_Language extends TRX_Addons_SOW_Widget {
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('ThemeREX Addons SOW - Layouts: Language', 'trx_addons'),
				array(
