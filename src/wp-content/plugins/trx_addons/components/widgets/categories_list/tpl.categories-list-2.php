	...
	foreach ($categories as $cat) {
		...
		<div class="categories_list_item">
			...
			if ($show_thumbs) {
				...
				?><div class="categories_list_image"><a href="<?php echo esc_url($cat_link); ?>"><?php
					$src = empty($image) 
			...
			?><h6 class="categories_list_title"><a href="<?php echo esc_url($cat_link); ?>" class="categories_list_label"><?php echo esc_html($cat->name); ?><?php
				if ($show_posts) { 
