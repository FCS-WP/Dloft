<?php
/**
 * CV Card Templates: Single Portfolio Slide - Style 1
 *
 * @package WordPress
...
?>
	<div class="trx_addons_cv_portfolio_item">
		...
		if (has_post_thumbnail()) {
			...
			?>
			<div class="trx_addons_cv_portfolio_item_thumb trx_addons_hover trx_addons_hover_style_wide">
		...
		<?php } ?>
		<h6 class="trx_addons_cv_portfolio_item_title"><a href="<?php echo esc_url($trx_addons_cv_post_link); ?>"><?php the_title(); ?></a></h6>
	</div>
<?php
