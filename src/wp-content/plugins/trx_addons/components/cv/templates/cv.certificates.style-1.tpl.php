<?php
/**
 * CV Card Templates: Single Certificate Slide
 *
 * @package WordPress
...
$trx_addons_cv_args = get_query_var('trx_addons_args_cv_certificates');
...
?>
	<div class="trx_addons_cv_certificates_item">
		<h6 class="trx_addons_cv_certificates_item_title"><a href="<?php echo esc_url(get_permalink()); ?>"><?php the_title(); ?></a></h6>
		<div class="trx_addons_cv_certificates_item_subtitle"><?php echo esc_html($trx_addons_cv_meta['subtitle']);?></div>
		<?php if (has_post_thumbnail()) { ?>
		<div class="trx_addons_cv_certificates_item_thumb trx_addons_hover trx_addons_hover_style_plain">
