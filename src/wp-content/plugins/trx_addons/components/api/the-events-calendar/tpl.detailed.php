<?php
/**
 * The style "detailed" of the Tribe Events
 *
 * @package WordPress
...
if ($query->found_posts > 0) {
	...
	?><div class="sc_events sc_events_detailed<?php
		...
		while ( $query->have_posts() ) { $query->the_post();
			trx_addons_get_template_part(TRX_ADDONS_PLUGIN_API . 'the-events-calendar/tpl.detailed-item.php', 'trx_addons_args_sc_events', $args);
		}
