...
if (!function_exists('palladio_customizer_get_css')) {

	function palladio_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = palladio_customizer_add_theme_fonts($fonts);
...
.palladio_tabs .palladio_tabs_titles li a {
...
EOT;
			$rez = apply_filters('palladio_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(palladio_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = palladio_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = palladio_customizer_add_theme_colors($colors);
...
.sc_button_simple_line:not(.sc_button_bg_image):before,
.sc_button_simple_line:not(.sc_button_bg_image):after {
	color:{$colors['text_link']};
}
.sc_button_simple_line:not(.sc_button_bg_image):hover {
	color:{$colors['text_link']} !important;
}
.sc_button_simple_line:not(.sc_button_bg_image):hover:before,
.sc_button_simple_line:not(.sc_button_bg_image):hover:after {
}
.sc_button_simple_line .sc_button_title:after{
...
.sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):before,
.sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):after,
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image),
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):before,
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):after,
.sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover,
.sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover:before,
.sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover:after,
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover,
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover:before,
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover:after {
	color:{$colors['inverse_text']} !important;
}
.sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover:before,
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover:before{
...
.sc_button_simple_line.color_style_dark:not(.sc_button_bg_image)  .sc_button_title:after,
.color_style_dark .sc_button_simple_line:not(.sc_button_bg_image) .sc_button_title:after{
	background-color:{$colors['inverse_text']};
}

.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image),
.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):before,
.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):after,
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image),
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):before,
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):after,
.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover,
.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover:before,
.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover:after,
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover,
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover:before,
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover:after {
	color:{$colors['text_dark']} !important;
}
.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image):hover:before,
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image):hover:before{
...
.scheme_dark .sc_button_simple_line.color_style_dark:not(.sc_button_bg_image)  .sc_button_title:after,
.scheme_dark .color_style_dark .sc_button_simple_line:not(.sc_button_bg_image) .sc_button_title:after{
	background-color:{$colors['text_dark']};
}
...
/* ThemeREX Addons */
.sc_button_default,
.sc_button:not(.sc_button_simple):not(.sc_button_simple_line):not(.sc_button_bordered):not(.sc_button_bg_image),
...
.woocommerce-checkout .woocommerce .button, .woocommerce-checkout.woocommerce-page .button,
.woocommerce-checkout .woocommerce a.button, .woocommerce-checkout.woocommerce-page a.button,
.woocommerce-checkout .woocommerce button.button, .woocommerce-checkout.woocommerce-page button.button,
.woocommerce-checkout .woocommerce input.button, .woocommerce-checkout.woocommerce-page input.button,
.woocommerce-checkout .woocommerce input[type="button"], .woocommerce-checkout.woocommerce-page input[type="button"],
.woocommerce-checkout .woocommerce input[type="submit"], .woocommerce-checkout.woocommerce-page input[type="submit"],
...
.woocommerce-cart .woocommerce .button, .woocommerce-cart.woocommerce-page .button,
...
.woocommerce-cart .woocommerce input[type="button"], .woocommerce-cart.woocommerce-page input[type="button"],
.woocommerce-cart .woocommerce input[type="submit"], .woocommerce-cart.woocommerce-page input[type="submit"],
...
.sc_button.color_style_dark:not(.sc_button_simple):not(.sc_button_simple_line):not(.sc_button_bordered):not(.sc_button_bg_image) {
...
.sc_button:not(.sc_button_simple):not(.sc_button_simple_line):not(.sc_button_bordered):not(.sc_button_bg_image):hover,
...
.sc_button.color_style_link2:not(.sc_button_simple):not(.sc_button_simple_line):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	background-color: {$colors['text_hover2']};
}
.sc_button_default.color_style_link3:hover,
.sc_button.color_style_link3:not(.sc_button_simple):not(.sc_button_simple_line):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	background-color: {$colors['text_hover3']};
}
.sc_button_default.color_style_dark:hover,
.sc_button.color_style_dark:not(.sc_button_simple):not(.sc_button_simple_line):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link']};
}
...
.sc_form_field.sc_form_field_button:after{
	color: {$colors['text_dark']};
	background-color: transparent;
	border-color: {$colors['text_dark']};
...
.sc_form_field.sc_form_field_button:before{
	color: {$colors['inverse_text']};
	background-color: {$colors['text_dark']};
	border-color: {$colors['text_dark']};
}
...
.sticky_wrap .sticky .post_title a {
    color:{$colors['inverse_text']};
}
.sticky_wrap .sticky .post_title a:hover {
    color:{$colors['text']};
}
...
.sticky_wrap .post_meta a,
.sticky_wrap .post_meta span {
	color: {$colors['text']};
}
.sticky_wrap .post_meta a:hover {
	color: {$colors['inverse_text']};
}
...
.sticky_wrap .post_meta .post_categories a:hover {
	color: {$colors['inverse_text']};
...
.palladio_tabs .palladio_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.palladio_tabs .palladio_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.footer_wrap .mejs-embed,
.footer_wrap .mejs-embed body {
	background: {$colors['alter_bg_color_07']};
}
...
.format-audio .post_featured.with_thumb .mask + .post_audio .mejs-controls .mejs-time {
	color: {$colors['inverse_text']};
}
...
.widget_calendar th, .scheme_self.sidebar .widget_calendar th,
.wp-block-calendar th, .scheme_self.sidebar .wp-block-calendar th {
	color: {$colors['text']};
}
.scheme_self.sidebar .widget_calendar caption, .scheme_self.sidebar .widget_calendar tbody td a,
.scheme_self.sidebar .wp-block-calendar caption, .scheme_self.sidebar .wp-block-calendar tbody td a{
	color: {$colors['alter_dark']};
}
...
.scheme_self.footer_wrap .widget .select_container,
.footer_wrap .scheme_self.vc_row .widget .select_container,
.scheme_self.footer_wrap .widget .select_container:before,
.footer_wrap .scheme_self.vc_row .widget .select_container:before,
.scheme_self.footer_wrap .widget .select_container select,
.footer_wrap .scheme_self.vc_row .widget .select_container select {
...
.single .post_meta .post_categories a:hover,
.post_layout_excerpt .post_meta .post_categories a:hover{
	color: {$colors['inverse_text']};
	background-color: {$colors['text_dark']};
}
...
.post_layout_excerpt .post_meta .post_counters_item:hover,
.post_layout_excerpt .post_meta .post_counters_item:hover > *{
	color: {$colors['text']};
}

.sc_content.scheme_dark .wpb_text_column p{
	color:{$colors['text_dark']};
}


/* Anchor */
.menu_style_default .menu_side_inner {
    background-color: transparent !important;
}
.menu_style_default .scheme_self.menu_side_icons .toc_menu_item .toc_menu_icon,
.menu_style_default .menu_side_inner > .toc_menu_item .toc_menu_icon,
.menu_style_default .scheme_self.menu_side_icons .toc_menu_item:hover .toc_menu_icon,
.menu_style_default .scheme_self.menu_side_icons .toc_menu_item_active .toc_menu_icon,
.menu_style_default .menu_side_inner > .toc_menu_item:hover .toc_menu_icon,
.menu_style_default .menu_side_inner > .toc_menu_item_active .toc_menu_icon {
    background-color: transparent !important;
	color: {$colors['text_dark']} !important;
}
.menu_style_default .menu_side_icons .toc_menu_item .toc_menu_icon, 
...
.mailto .sc_layouts_item_details_line1:hover {
	color:{$colors['text_dark']}!important;
}
...
EOT;
					...
					$rez = apply_filters('palladio_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'palladio_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>