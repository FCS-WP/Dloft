...
if (!function_exists('palladio_trx_addons_get_css')) {
	add_filter('palladio_filter_get_css', 'palladio_trx_addons_get_css', 10, 4);
	function palladio_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.header_position_over .sc_layouts_row_type_narrow .sc_layouts_item_icon {
...
.scheme_dark.sc_layouts_row_type_narrow .sc_layouts_item_link:hover .sc_layouts_item_icon,
...
.top_panel_default .sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button):not(.button),
.top_panel_default .scheme_self.sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button):not(.button) {
	color: {$colors['text_dark']};
}
.top_panel_default .sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button):not(.button):hover,
.top_panel_default .scheme_self.sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button):not(.button):hover,
.top_panel_default .sc_layouts_row_type_compact .sc_layouts_item a:hover .sc_layouts_item_icon,
.top_panel_default .scheme_self.sc_layouts_row_type_compact .sc_layouts_item a:hover .sc_layouts_item_icon {
	color: {$colors['text']};
}
...
.sc_layouts_row_type_compact .sc_layouts_item_link:hover .sc_layouts_item_details_line1,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item_link:hover .sc_layouts_item_details_line1{
	color: {$colors['text']};
}
...
.sc_layouts_menu_popup .sc_layouts_menu_nav > li.current-menu-item > a,
...
.sc_testimonials.color_style_default .sc_slider_controls .slider_controls_wrap > a,
.sc_testimonials.color_style_default .slider_swiper.slider_controls_side .slider_controls_wrap > a,
.sc_testimonials.color_style_default .slider_outer_controls_side .slider_controls_wrap > a,
.sc_testimonials.color_style_default .sc_slider_controls .slider_controls_wrap > a:hover,
.sc_testimonials.color_style_default .slider_swiper.slider_controls_side .slider_controls_wrap > a:hover,
.sc_testimonials.color_style_default .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['text_dark']};
	background-color: transparent;
	border-color: {$colors['text_dark']};
}
...
.slider_style_dark .sc_slider_controls .slider_controls_wrap > a,
.slider_style_dark .slider_swiper.slider_controls_side .slider_controls_wrap > a,
.slider_style_dark .slider_outer_controls_side .slider_controls_wrap > a,
.sc_testimonials.scheme_dark .sc_slider_controls .slider_controls_wrap > a,
.sc_testimonials.scheme_dark .slider_swiper.slider_controls_side .slider_controls_wrap > a,
.sc_testimonials.scheme_dark .slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['extra_text']};
	background-color: transparent;
	border-color: {$colors['extra_text']};
}
.slider_style_dark .sc_slider_controls .slider_controls_wrap > a:hover,
.slider_style_dark .slider_swiper.slider_controls_side .slider_controls_wrap > a:hover,
.slider_style_dark .slider_outer_controls_side .slider_controls_wrap > a:hover,
.sc_testimonials.scheme_dark .sc_slider_controls .slider_controls_wrap > a:hover,
.sc_testimonials.scheme_dark .slider_swiper.slider_controls_side .slider_controls_wrap > a:hover,
.sc_testimonials.scheme_dark .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['extra_text']};
	background-color: transparent;
	border-color: {$colors['extra_text']};
	opacity: 0.4;
...
.sc_slider_controls.sc_slider_controls_dark .slider_controls_wrap > a{
	color: {$colors['extra_bg_color']};
	background-color: transparent;
	border-color: {$colors['extra_bg_color']};
}
.sc_slider_controls.sc_slider_controls_dark .slider_controls_wrap > a.slider_prev:before{
    border-right-color: {$colors['extra_bg_color']};
}
.sc_slider_controls.sc_slider_controls_dark .slider_controls_wrap > a.slider_next:before{
    border-left-color: {$colors['extra_bg_color']};
}
...
.sc_blogger_modern .post_meta .post_counters_item,
.sc_blogger_modern .post_meta .post_counters_item {
    color: {$colors['text_dark']};
    border-color: {$colors['text_dark']};
} 
.sc_blogger_modern .sc_blogger_item_title a:hover,
.sc_blogger_modern .post_meta .post_counters_item:hover,
.sc_blogger_modern .post_meta .post_counters_item:hover {
    color: {$colors['text']};
    border-color: {$colors['text']};
} 
...
.sc_price_item:hover .sc_price_item_info{
	background-color: {$colors['alter_bg_color']};
	border-color: {$colors['alter_bg_color']};
}
...
.sc_layouts_468 .sc_team_short .sc_team_item .sc_team_item_info {
    background-color: {$colors['alter_bg_color']};
}
.sc_layouts_468 .sc_team_short .sc_team_item:hover .sc_team_item_info {
    background-color: {$colors['bg_color']};
}
...
#trx_addons_login_popup.trx_addons_popup .trx_addons_tabs_content {
	background-color: {$colors['alter_bg_color']};
}
...
.woocommerce .woocommerce-message .button:hover, .woocommerce ul.products li.product .button:hover, .woocommerce div.product form.cart .button:hover{
    color: {$colors['text_hover']};
    background-color: transparent;
}
...
.sc_promo_image .sc_promo_button_on_image {
	background-color: {$colors['bg_color']};
}


.header_position_over header .sc_layouts_row.sc_layouts_row:not(.sc_layouts_row_fixed_on) {
	background-color: transparent;
}
.header_position_over header .sc_layouts_row.sc_layouts_row.sc_layouts_row_fixed_on {
    background-color: {$colors['inverse_bd_color']};
}
.header_position_over header .sc_layouts_row_type_narrow .sc_layouts_item a {
	color: {$colors['inverse_text']};
}
.header_position_over header .sc_layouts_row_type_narrow .sc_layouts_item a:hover,
.header_position_over header .sc_layouts_row_type_narrow .sc_layouts_item a:hover .sc_layouts_item_icon{
	color: {$colors['inverse_text']};
}
.header_position_over header .sc_layouts_menu_nav > li > a {
	color: {$colors['inverse_text']};
}
.header_position_over header .sc_layouts_menu_nav > li > a:hover,
.header_position_over header .sc_layouts_menu_nav > li.sfHover > a {
	color: {$colors['inverse_text']} !important;
}
.header_position_over header .sc_layouts_menu_nav > li.current-menu-item > a,
.header_position_over header .sc_layouts_menu_nav > li.current-menu-parent > a,
.header_position_over header .sc_layouts_menu_nav > li.current-menu-ancestor > a {
	color: {$colors['inverse_text']} !important;
}
.header_position_over header .menu_hover_slide_line .sc_layouts_menu_nav > li#blob {
