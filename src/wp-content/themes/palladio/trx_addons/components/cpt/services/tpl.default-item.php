...
?>
<div class="sc_services_item custom<?php
...
?>">
    <div class="sc_services_item_wrap_featured">
        ...
        <div class="sc_services_item_header">
            <h6 class="sc_services_item_title"><?php the_title(); ?><span class="sc_services_item_title_line"></span><span class="sc_services_item_title_icon"></span></h6>
        </div>
    </div>
